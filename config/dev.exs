...
config :boogaloo, Boogaloo.Repo,
  database: Path.expand("../boogaloo_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :boogaloo, BoogalooWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/boogaloo_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :boogaloo, dev_routes: true, token_signing_secret: "U9zQGqBDWanA6eFQPQ5jg5mUOlCkyZfM"
